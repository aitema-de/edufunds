...
export const PACKS: Pack[] = [
  ...
  },
  {
    ...
    priceCents: 13990,
    label: "5 Antraege",
    description: "Kontingent fuer Schulen mit einzelnen Projekten pro Jahr.",
    isQuota: true,
  },
  {
    id: "pack10",
    ...
    priceCents: 24990,
    label: "10 Antraege",
    description: "Kontingent fuer aktive Schulen mit mehreren Vorhaben.",
    isQuota: true,
  },
  {
    id: "pack20",
    ...
    priceCents: 45990,
    label: "20 Antraege",
    description: "Kontingent fuer Schultraeger mit mehreren Schulen.",
    isQuota: true,
  },
];
