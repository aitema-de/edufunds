...
export function buildMagicLinkEmail(verifyUrl: string): MailContent {
  ...
  const html = `
  <div style="font-family:Arial,Helvetica,sans-serif;color:#0a1628;max-width:520px;margin:0 auto;line-height:1.5">
    <h2 style="color:#0a1628">Deine Anträge öffnen</h2>
    <p>Mit diesem Link siehst du deine begonnenen und fertigen Anträge auf jedem Gerät.</p>
    <p style="margin:24px 0">
      <a href="${safeUrl}"
         style="display:inline-block;background:#c9a227;color:#0a1628;font-weight:bold;
