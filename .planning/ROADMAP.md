...
- [x] 04-01-queue-status-expired-cleanup-PLAN.md — lib/wizard/queue.ts neu mit Status-Enum-Erweiterung 'expired' + scripts/cleanup-expired-queue.ts mit HTTP-HEAD + Frist-Check (D-04/D-05/D-06, Wave 1, autonomous) ✓ 2026-05-19
- [x] 04-02-migrate-legacy-dossier-script-PLAN.md — scripts/migrate-legacy-dossier.ts Targeted-Fill-CLI fuer einzelnes Legacy-Dossier (D-07, Wave 1, autonomous, parallel zu 04-01) ✓ 2026-05-19
- [x] 04-03-sample-first-migration-vollmigration-PLAN.md — Sample-First-Migration (bmbf-digitalpakt-2 + ferry-porsche-challenge-2025) + Vollmigration aller 11 Dossiers auf Branch dossier-migration/phase-04 (D-08/D-09, Wave 2, NOT autonomous: 2 Review-Checkpoints, depends_on 04-02) ✓ 2026-05-19
...
- [x] 05-02-PLAN.md — Wave 1 Korpus-Kuration (pipeline-korpus.json, 22 Eintraege, 2 Kolja-Checkpoints D-14)
- [x] 05-03-PLAN.md — Wave 1 geber-classification.ts + config.ts (D-22/-28, 4 Feature-Flags default OFF)
- [x] 05-04-PLAN.md — Wave 2 eval-pipeline.ts + Baseline-N=3-Run + BASELINE.md-Phase-5-Eintrag (D-07/-09/-15/-16)
...
- [ ] 06-02-PLAN.md — Framework: 3–5 manuelle Session-Checkpoints (D-09/D-10) + Post-Session-Antrag-Bewertung (D-23) + Rolling-Blocker-Fix (D-01) (Wave 2, NOT autonomous)

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 06-03-PLAN.md — Framework: konsolidierte Bug-Fix-Welle — rot→grün Eval-Cases (D-17/D-18) + ein atomarer Commit pro Bug (D-06) + voller Korpus-Lauf als Wellen-Gate (D-08) (Wave 3, NOT autonomous)

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 06-04-PLAN.md — BASELINE.md Phase-6-Eintrag + CI-Eval-Re-Run (D-25) + PILOT-UAT-RETRO.md Abschluss-Memo (D-19/D-20/D-24) (Wave 4, NOT autonomous)
