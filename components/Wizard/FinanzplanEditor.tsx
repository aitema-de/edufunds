      ...
      <header className="mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={exportCsv}
            className="inline-flex items-center gap-2 rounded-lg border border-[#1c1917]/15 px-3 py-1.5 text-xs text-[#57534e] hover:bg-slate-100"
          >
              ...
              <tr key={p.id} className="border-b border-[#1c1917]/10 align-top">
                <td className="py-2 pr-3">
                  ...
                  <input
                    ...
                    className="w-full rounded border border-[#1c1917]/15 bg-white p-1.5 text-[#1c1917] placeholder-slate-400 disabled:opacity-60"
                  />
                  <input
                    type="text"
                    value={p.begruendung ?? ""}
                    ...
                    className="mt-1 w-full rounded border border-[#1c1917]/15 bg-white p-1 text-xs text-slate-600 placeholder-slate-600 disabled:opacity-60"
                  />
                </td>
                <td className="py-2 pr-3">
                  <select
                    ...
                    className="rounded border border-[#1c1917]/15 bg-white p-1.5 text-[#1c1917] disabled:opacity-60"
                  >
                ...
                <td className="py-2 pr-3">
                  <input
                    ...
                    className="w-32 rounded border border-[#1c1917]/15 bg-white p-1.5 text-right tabular-nums text-[#1c1917] disabled:opacity-60"
                  />
                </td>
                <td className="py-2">
                  {!legitimized && (
      ...
      {!legitimized && (
        <div className="mt-3">
          <button
            type="button"
            onClick={addPosten}
            className="inline-flex items-center gap-1.5 rounded border border-[#1c1917]/15 px-3 py-1.5 text-xs text-slate-700 hover:bg-white"
          >
      ...
      {!legitimized && autofixes.length > 0 && (
        <div className="mt-4 rounded-lg border border-[#78350f]/40 bg-[#78350f]/5 p-3">
          ...
          <ul className="space-y-2">
            {autofixes.map((a) => (
              <li key={a.id} className="flex flex-col gap-1 rounded-md border border-[#1c1917]/15 bg-[#fdfdfc] p-2 sm:flex-row sm:items-start sm:gap-3">
                <div className="flex-1 text-xs text-slate-700">
                  <div className="font-medium text-[#1c1917]">{a.label}</div>
      ...
      {!legitimized && (
        <div className="mt-4 flex flex-wrap items-center justify-end gap-3">
          <button
            ...
            disabled={busy || !dirty}
            onClick={save}
            className="rounded-lg border border-[#1c1917]/15 px-4 py-2 text-sm text-[#57534e] transition hover:bg-slate-100 disabled:opacity-50"
          >
