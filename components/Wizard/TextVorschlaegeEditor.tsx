...
export function TextVorschlaegeEditor({ sessionToken, finalText, vorschlaege, onChange }: Props) {
  ...
  return (
    <div className="mt-6 rounded-lg border border-[#c9a227]/30 bg-[#c9a227]/5 p-4">
      ...
      <ul className="space-y-2 text-xs text-[#1e3a61]">
        {vorschlaege.map((v, i) => (
          <li key={i} className="rounded border border-[#0a1628]/10 bg-white p-2.5">
            {editing === i ? (
              <div className="flex flex-col gap-2">
                <textarea
                  ...
                  rows={3}
                  className="w-full rounded border border-[#0a1628]/20 p-2 text-xs text-[#1e3a61] focus:border-[#c9a227] focus:outline-none"
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="inline-flex items-center gap-1 rounded bg-[#1e3a61] px-2.5 py-1 text-xs font-medium text-white hover:bg-[#0a1628] disabled:opacity-40"
                  >
                  ...
                  <button
                    ...
                    disabled={busy === i}
                    className="inline-flex items-center gap-1 rounded border border-[#0a1628]/15 px-2.5 py-1 text-xs text-[#1e3a61] hover:bg-slate-100 disabled:opacity-40"
                  >
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex shrink-0 gap-1">
                  ...
                  <button
                    ...
                    title="Bearbeiten"
                    aria-label="Vorschlag bearbeiten"
                    className="rounded p-1 text-[#1e3a61] hover:bg-slate-100 disabled:opacity-40"
                  >
