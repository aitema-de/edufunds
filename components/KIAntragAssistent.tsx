...
export function KIAntragAssistent({ programm, onClose }: KIAntragAssistentProps) {
  ...
  if (step === "generating") {
    return (
      <Card className="w-full max-w-2xl mx-auto border-gold-500/30">
        <CardContent className="pt-12 pb-12">
          <div className="flex flex-col items-center justify-center space-y-6">
            <div className="relative">
              <div className="absolute inset-0 bg-gold-500/20 blur-xl rounded-full animate-pulse" />
              <Loader2 className="h-16 w-16 text-gold-500 animate-spin relative" />
            </div>
  ...
  if (step === "result") {
    return (
      <Card className="w-full max-w-4xl mx-auto border-gold-500/30">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Button
                ...
                className="gap-2 bg-gold-500 hover:bg-gold-600 text-ink"
              >
        ...
        <CardContent className="pt-6">
          ...
          <div className="mt-6 p-4 bg-gold-500/10 rounded-lg border border-gold-500/20">
            <div className="flex items-start gap-3">
              <Sparkles className="h-5 w-5 text-gold-500 mt-0.5" />
              <div className="text-sm text-slate-300">
                <p className="font-medium text-gold-500 mb-1">KI-Hinweise</p>
                <p>
      ...
      <CardContent className="pt-6 space-y-6">
        ...
        <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-700/50">
          ...
          <Button
            ...
            className="gap-2 bg-gold-500 hover:bg-gold-600 text-ink disabled:opacity-50"
          >
            <Sparkles className="h-4 w-4" />
