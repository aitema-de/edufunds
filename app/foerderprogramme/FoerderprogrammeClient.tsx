      ...
      <main id="main-content" className="min-h-screen pt-24 pb-20">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6" style={{ backgroundColor: 'rgba(120, 53, 15, 0.1)', border: '1px solid rgba(120, 53, 15, 0.2)' }}>
              <School className="h-4 w-4" style={{ color: '#78350f' }} />
              <span className="text-sm font-medium" style={{ color: '#78350f' }}>Förderfinder</span>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-12">
            <div className="glass rounded-xl p-4 text-center">
              <div className="text-2xl font-bold" style={{ color: '#78350f' }}>{PROGRAMM_COUNT_LABEL}</div>
          ...
          <div className="glass rounded-2xl p-6 mb-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <Filter className="h-5 w-5" style={{ color: '#78350f' }} />
                <h2 className="font-semibold text-[#57534e]">Filter</h2>
                {aktiveFilterCount > 0 && (
                  <span className="px-2 py-0.5 rounded-full text-xs" style={{ backgroundColor: 'rgba(120, 53, 15, 0.2)', color: '#78350f' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white border border-[#1c1917]/15 text-[#57534e] text-sm placeholder:text-slate-500 focus:outline-none focus:border-[#78350f]/50 focus:ring-1 focus:ring-[#78350f]/50 transition-all"
                  />
                  {suchbegriff && (
                    <button
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-white border border-[#1c1917]/15 text-[#57534e] text-sm focus:outline-none focus:border-[#78350f]/50 focus:ring-1 focus:ring-[#78350f]/50 transition-all cursor-pointer appearance-none"
          ...
          <div className="space-y-6">
            {gefilterteProgramme.length === 0 ? (
              ...
              gefilterteProgramme.map((programm) => (
                <article 
                  key={programm.id}
                  className="glass rounded-2xl p-6 md:p-8 hover:border-[#78350f]/30 transition-all group"
                >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-2 mb-3">
                        ...
                        {programm.kiAntragGeeignet && (
                          <span className="px-2 py-1 rounded-full text-xs font-medium bg-[#78350f]/20 text-[#78350f]">
                            KI-geeignet
                          </span>
                        )}
                      ...
                      {/* Titel */}
                      <h3 className="text-xl font-bold text-[#1c1917] mb-2 group-hover:text-[#78350f] transition-colors">
                        {programm.name}
                      </h3>
