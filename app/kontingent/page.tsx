        ...
        <section className="pt-32 pb-12">
          <div className="container mx-auto px-6 max-w-4xl text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: INK }}>
              Anträge zentral <span style={{ color: "#1e3d32" }}>vorab freischalten</span>
            </h1>
          ...
          <section className="pb-24">
            <div className="container mx-auto px-6 max-w-2xl">
              <motion.div
                ...
                style={{ border: "1px solid rgba(30, 61, 50, 0.3)" }}
              >
                ...
                {cardCode ? (
                  ...
                  <p className="text-sm leading-relaxed" style={{ color: "#64748b" }}>
                    ...
                    <a href="mailto:office@aitema.de" style={{ color: "#1e3d32" }}>
                      office@aitema.de
                    </a>
                    .
                  </p>
